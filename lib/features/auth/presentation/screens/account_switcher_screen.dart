            ...
            children: [
              ...
              Expanded(
                child: accountsAsync.when(
                  ...
                  loading: () =>
                      const ShimmerListSkeleton(count: 2, trailingWidth: 36),
                  // Kutilmagan xato (masalan tarmoq) - xom `Exception: ...`
                  // matnini foydalanuvchiga ko'rsatish o'rniga, boshqa
                  // ekranlardagi bilan bir xil xato/qayta urinish holati.
                  error: (e, stack) => ErrorRetryView(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                UserAvatar(
                  size: 40,
                  initials: (account.info.username ?? account.info.email)[0]
                      .toUpperCase(),
