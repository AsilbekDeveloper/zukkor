...
/// Dark card showing overlapping decorative avatars + a "duel" shortcut
/// — mirrors the prototype's `.friends`. [friendCount] is the real
/// number of friends (there's no online/presence concept).
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      context.t.common.friendsCount(count: friendCount),
                      maxLines: 1,
