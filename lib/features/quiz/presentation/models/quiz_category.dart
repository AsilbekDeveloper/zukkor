...
class QuizCategory {
  ...
  static const Map<String, IconData> _iconByName = {
    ...
    'karate': TablerIcons.karate,
    'trophy': TablerIcons.trophy,
    'music': TablerIcons.music,
    'building-bank': TablerIcons.buildingBank,
    'device-gamepad-2': TablerIcons.deviceGamepad2,
    'brand-flutter': TablerIcons.brandFlutter,
    'code': TablerIcons.code,
    'chef-hat': TablerIcons.chefHat,
    'dna': TablerIcons.dna,
    'atom': TablerIcons.atom,
    'flask-2': TablerIcons.flask2,
    'device-mobile': TablerIcons.deviceMobile,
    'rocket': TablerIcons.rocket,
